...
import com.whatsapp.clone.application.messaging.domain.user.aggregate.AuthorityBuilder;
...
/**
 * @Created 4/7/2024 - 5:38 PM on (Thursday)
 * @Package com.whatsapp.clone.application.infrastructure.secondary.entity
...
public class AuthorityEntity {
    ...
    public static Set<AuthorityEntity> from(Set<Authority> authorities) {
        return authorities
                .stream()
                .map(authority ->
                        com.whatsapp.clone.application.infrastructure.secondary.entity.AuthorityEntityBuilder.authorityEntity()
